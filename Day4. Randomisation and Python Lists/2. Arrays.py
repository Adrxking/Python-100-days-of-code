# Definir un array
america_states = [ "AK - Alaska", "AL - Alabama", "AR - Arkansas", "AS - American Samoa", "AZ - Arizona", 
...
num_of_states = len(america_states)

# Add to the end of the array
america_states.append("Cabraloca")
# Add to the end a new array
america_states.extend(["Cabraloca", "Vacaloca"])
